...
def _wheel_files(path: Path, version: str) -> dict[str, bytes]:
    ...
    required = {
        "cernora/__init__.py",
        "cernora/core/agent_run.py",
        "cernora/evaluation/agent_export.py",
        "cernora/schemas/agent-run-export-v1.schema.json",
        ...
        "cernora/examples/profile_authoring/__init__.py",
        "cernora/examples/tool_workflow/__main__.py",
        "cernora/examples/tool_workflow/resources/scenarios.json",
        "cernora/profiles/tool_workflow/resources/profile.json",
        "cernora/profiles/tool_workflow/resources/workflow-v1.json",
        "cernora/profiles/coding_evaluation/resources/authority-v1.json",
        "cernora/profiles/coding_evaluation/resources/oracle-v1.json",
        "cernora/profiles/coding_evaluation/resources/profile.json",
